        ...
        <div className="container mx-auto px-6">
          ...
          >
            <a
              ...
              className="block rounded-2xl border-2 border-border bg-muted shadow-md hover:shadow-xl transition-shadow p-8 text-center group"
            >
              ...
              <p className="font-display text-lg font-bold text-primary group-hover:underline">
