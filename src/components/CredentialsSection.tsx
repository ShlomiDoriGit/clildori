      ...
      <div className="max-w-3xl mx-auto grid grid-cols-1 sm:grid-cols-2 gap-6">
        {certs.map((cert, i) => (
          <motion.div
            ...
            className="rounded-xl border-2 border-border bg-background shadow-sm overflow-hidden p-3"
          >
            <img
              src={cert.image}
              alt={cert.alt}
              ...
              loading="lazy"
            />
            <p className="text-center font-body text-xs text-muted-foreground mt-2">{cert.alt}</p>
          </motion.div>
        ))}
      </div>
    </div>
