...
הליווי שאני מציעה הינו תהליך מובנה, אישי ומבוסס מחקר, שמטרתו לייצר שינוי עמוק ויציב לאורך זמן.`,
  ...
  {
    title: "קלפי חיזוק",
    subtitle: "סט קלפים לקשר בריא עם אוכל",
    description:
      "סט קלפים שנוצר במיוחד עבור נשים המתמודדות עם מערכת יחסים מורכבת עם אוכל. כל קלף כולל מסר מעודד, נקודת מבט חדשה או שאלה להתבוננות.",
    points: null,
    note: null,
    price: "119 ש״ח",
    label: "מחיר השקה",
