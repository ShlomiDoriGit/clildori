...
import videoThumbnail from "@/assets/video-thumbnail-new.jpeg";
          ...
          >
            <a href="https://rb.gy/vfpdqu" target="_blank" rel="noopener noreferrer" className="block relative group">
              <div className="relative aspect-video">
                <img src={videoThumbnail} alt="סיפורי הצלחה" className="w-full h-full object-cover" />
        ...
        <div className="container mx-auto px-6">
          ...
          >
            <a
              ...
              className="block rounded-2xl border-2 border-border bg-muted shadow-md hover:shadow-xl transition-all hover:-translate-y-1 p-8 text-center group"
            >
              <div className="flex items-center justify-center gap-3 mb-4">
                ...
                <span className="font-display text-xl font-bold text-foreground">ביקורות Google</span>
              </div>
              <div className="flex items-center justify-center gap-1 mb-5">
                {[1,2,3,4,5].map(s => (
                  <svg key={s} className="w-7 h-7 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                  </svg>
                ))}
              </div>
              <span className="inline-flex items-center gap-2 rounded-full bg-primary text-primary-foreground px-8 py-3 text-base font-display font-bold shadow-md group-hover:shadow-lg transition-shadow">
